...
const Pagination = ({ page, pageCount, redirectUrl = '/' }: IPropType) => {
  ...
  return (
    <div className="flex items-center justify-center mt-24">
      ...
      />
      <Next handlePaginate={handlePaginate} isNextDisabled={isNextDisabled} />
    </div>
  );
};
...
const Previous: React.FC<{
  handlePaginate: (direction: TDirection) => Promise<void>;
  isPrevDisabled: () => boolean;
}> = ({ handlePaginate, isPrevDisabled }) => (
  <button
