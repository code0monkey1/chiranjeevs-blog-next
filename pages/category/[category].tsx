...
const Category = ({ categories, articles }: IPropType) => {
  ...
  const formattedCategory = () => {
    return capitalizeFirstLetter(makeCategory(categorySlug as string));
  };
  const handleSearch = (query: string) => {
    ...
    // query string
    const urlString = `/category/${categorySlug}/?search=${query}`;

    console.log(
      '🚀 ~ file: [category].tsx:47 ~ handleSearch ~ urlString:',
      urlString
    );
